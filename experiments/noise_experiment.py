...
from predictive_model_pinn.trainer_utils import (
    CosineLoss,
    Normalized_MSE,
    ScaleInvariantMSELoss,
    train,
)

# --- CONFIGURATION ---
EXPERIMENT_NAME = ""
MODEL_NAME = "SinCosModel"
...
if __name__ == "__main__":
    EXPERIMENT_NAME = "noise_CosineLoss"
    run_experiment(CosineLoss)

    EXPERIMENT_NAME = "noise_NormalizedMSE"
    run_experiment(Normalized_MSE)

    EXPERIMENT_NAME = "noise_ScaleInvariantMSE"
    run_experiment(ScaleInvariantMSELoss)

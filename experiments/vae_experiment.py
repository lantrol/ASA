...
from predictive_model_pinn.trainer_utils import CosineLoss
from predictive_model_pinn.trainer_vae_utils import train_vae

# --- CONFIGURATION ---
EXPERIMENT_NAME = "vae_baseline"
MODEL_NAME = "PatchVAETransformer"
MODEL_KWARGS = {}
...
def run_experiment():
    ...
    print(f"Starting VAE experiment: {EXPERIMENT_NAME}")

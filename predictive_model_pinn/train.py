...
from predictive_model_pinn.model import PredModel
    ...
    for epoch in range(epochs):
        ...
        if val_loader is not None:
            ...
            if avg_val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), "best_model_pinn.pth")
            else:
                counter += 1
                if counter >= patience:
...
if __name__ == "__main__":
    ...
    # Save the model
    model_path = "trained_model_pinn.pth"
